...
async function cargarEstadisticasMonitor() {
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/asistencias/hoy`, {
            headers: Auth.getHeaders()
        });
...
async function cargarEstadisticasHoy() {
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/asistencias/estadisticas/hoy`, {
            headers: Auth.getHeaders()
        });
...
async function aplicarFiltros() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/asistencias/rango-fechas?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`, {
            headers: Auth.getHeaders()
        });
